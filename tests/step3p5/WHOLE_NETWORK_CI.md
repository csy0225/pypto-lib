...
```text
canonical main  tests/step3p5/_stage_whole_faithful_real_ipc.py
MTP3 device     tests/step3p5/_stage_whole_mtp3_ipc.py
...
python -m tests.step3p5.run_whole_network_ci \
...
pytest -q tests/step3p5/test_whole_network_ci.py -s
```
...
```bash
pytest -q tests/step3p5/test_whole_network_ci_runner.py
```
