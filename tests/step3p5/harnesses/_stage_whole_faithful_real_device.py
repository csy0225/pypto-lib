...
integration (task #2 validation) later.
    ...
    python -m tests.step3p5.harnesses._stage_whole_faithful_real_device -p a2a3 --compile-only
    # full 8-card dispatch
    python -m tests.step3p5.harnesses._stage_whole_faithful_real_device -p a2a3 -d 0,1,2,3,4,5,6,7
