...
Usage::
    ...
    python -m tests.step3p5.system.test_decode_layer_full_dense_st --smoke
    python -m tests.step3p5.system.test_decode_layer_full_dense_st -p a2a3 -d 0
"""
...
def main() -> int:
    ...
    specs = [
        ...
        ScalarSpec("attn_layer_idx", torch.int32,
                   value=torch.tensor(layer_idx, dtype=torch.int32)),
        ScalarSpec("mlp_layer_idx", torch.int32,
                   value=torch.tensor(layer_idx, dtype=torch.int32)),
    ]
